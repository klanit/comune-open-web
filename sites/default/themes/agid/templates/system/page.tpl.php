...
<div class="body_wrapper fp_body_wrapper push_container clearfix" id="page_top">
	...
	<header class="header_container">
        ...
        <div class="main_nav_container fp_main_nav_container container-fullwidth menu_top main_nav_container_small">
			...
			<div class="container-fluid main-menu-area"> 
					...
					<?php if (!empty($page['menu_principale'])): ?>
					
						<?php print render($page['menu_principale']); ?>
		...
		<div class="section section_white section_first clearfix" id="area-0">
			<div class=" <?php print $container_class; ?>">
				<div class="row">
					...
					<!-- #sidebar-second -->
					<aside class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-4 col-xs-12 sidebar" role="complementary">
    ...
    <div class="section section_grey clearfix" id="area-1">
    ...
    <div class="section section_white clearfix" id="area-2">
    ...
    <div class="section section_grey clearfix" id="area-3">
    ...
    <div class="section section_white clearfix" id="area-4">
    ...
    <div class="section section_blue clearfix" id="area-5">
